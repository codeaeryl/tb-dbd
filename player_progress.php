		...
		<content>
			...
			<table>
				...
				<tr>
					...
					<td><?php echo $row['stars_earned'] ?></td>
                    <td><?php echo $row['times_played'] ?></td>
                    <td><?php echo $row['times_completed'] ?></td>
                    <td><?php echo $row['best_time'] ?></td>
                    <td><?php echo $row['is_unlocked'] ?></td>
				</tr>
					<?php
					}
					?>

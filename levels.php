		...
		<content>
			...
			<table>
				...
				<tr>
					...
					<td><?php echo $row['moves_allowed'] ?></td>
					<td><?php echo $row['target_score'] ?></td>
                    <td><?php echo $row['required_stars'] ?></td>
                    <td><?php echo $row['required_jellies'] ?></td>
                    <td><?php echo $row['color'] ?></td>
                    <td><?php echo $row['required_color'] ?></td>
				</tr>
					<?php
					}
					?>
